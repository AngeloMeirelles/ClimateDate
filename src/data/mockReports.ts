...
export const reports: Report[] = [
  {
    ...
    period: "Maio 2026",
    date: "2026-05-15",
    summary: "Foram registrados 12 eventos climáticos extremos no período, com destaque para tempestades severas na Zona Norte.",
    data: [
      ...
      { label: "Região mais afetada", value: "Zona Norte" },
  ...
  },
  {
    ...
    period: "Abril 2026",
    date: "2026-04-30",
    summary: "A Zona Leste apresentou risco elevado de enchente em 40% dos dias do mês, principalmente devido ao acúmulo pluviométrico.",
    data: [
